...
NODE_CLASS_MAPPINGS = CONVERT_CLASS_MAP | LOADER_CLASS_MAP | ONNX_CLASS_MAP | MO_CLASS_MAP
NODE_DISPLAY_NAME_MAPPINGS = CONVERT_NAME_MAP | LOADER_NAME_MAP | ONNX_NAME_MAP | MO_NAME_MAP
